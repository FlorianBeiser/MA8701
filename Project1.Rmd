...
@YG: Please trim the boxplot as discussed in the meeting on Wednesday 
@YG: Please change the order to follow the narrative which we discussed in the meeting on Wednesday

```{r,echo = F, eval=T, tidy = F, fig.width=16, fig.height=8, fig.cap="\\label{fog:bootstap}@YG: Please provide caption"}
...
```
@YG: Please provide description of plots and use \ref{fig:bootstrap} for referring 
...
@YG: Please provide a conclusion of the inference section in one short sentence
