...
```{r,echo = F, eval=T, tidy = F, fig.width=16, fig.height=4}
...
```{r, echo = F, eval=T, tidy = F, fig.width=15, fig.height=5, fig.cap="\\label{fig:boxplot_lasso} Boxplot of the bootstrapped group lasso selected coefficients"}
