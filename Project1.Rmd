...
xs=model.matrix(nm~.,data=munich_house)[,-c(1:2)] # to take care of categorical variables, but not include the intercept column
xss=scale(xs)
...
```{r,echo = F, eval=T, tidy = F, fig.width=20, fig.height=8}
