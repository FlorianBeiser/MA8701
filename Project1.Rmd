...
```{r loadData,eval=TRUE,echo=FALSE, fig.width = 25, fig.align="center", fig.cap="\\label{fig:corrplot}Correlation between the covariates"}
# Load data set
...
<!-- After we saw the results for the plain linear regression, we continue with the shrinkage methods. -->
