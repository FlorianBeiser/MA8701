...
# ```{r,echo = F, eval=T, tidy = F, fig.width=15, fig.height=5}
# boostrap loop
set.seed(2021)
B=100
n=nrow(x_mod)
...
# par(mfrow = c(1, 1))
lassopp=ggplot2(lassods,aes(x=Var2,y=value))+
...
ridgepp=ggplot2(ridgeds,aes(x=Var2,y=value))+
