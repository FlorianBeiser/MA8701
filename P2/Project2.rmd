...
plot(as.POSIXct(data_test[,"time"],format="%Y-%m-%d %H:%M:%S"),data_test[,"response"], 
     xlab="time", ylab="degC", pch=20, col="orange")
...
The MSE for the prediction sets is  0.6135239601135254
